      ...
      this.each(function() { 
        ...
        $.Body
          .bind($.Events.OMNITURE_TRACK,
            function(e,id) {
              trackContent('http://www.wavetele.com/'+id)
            })
          ...
          .bind('mouseleave',
            function(e) {
              if ($.browser.msie)
                ...
                $h1.stop().animate({left:115,opacity:0},450,'easeOutQuart',function(){$h1.stop().css({display:'none'})})
            });
        ...
        $a_fb
          .bind('click',
            function(e){
              ...
              var _fb = window.open('http://www.facebook.com/sharer.php?s=100&p[url]=http://wavetele.com&p[title]='+headline()+'&p[images][0]=https://dl.dropboxusercontent.com/u/47807983/wavetele.com/images/nbw_facebook.png' ,'_fb','width=550,height=450')
        ...
        $a_twitter
          .bind('click',
            function(e){
              ...
              var _tweet = window.open('http://twitter.com/?status='+headline(1) + escape(' #wavetelecoms'),'_tweet','width=1024,height=600,scrollbars=yes')
...
//andre test button (icon_share_orkut.png) for the css class "orkut" (this is the first of two button function calls). this is for the footer icon
   ...
   $a_orkut
          ...
          //i am going to need to change this variable "_fb" to "_orkut" in both of my button functions once i get the correct url
              var _orkut = window.open('http://promote.orkut.com/preview?nt=orkut.com&tn=http://www.wavetele.com/images/nbw_facebook.png&tt=Nike%20Better%20World%20&du=http://www.wavetele.com&cn='+headline(),'_orkut','width=550,height=450')
...
//end of andre test
        ...
        function headline(tw) {
          ...
          if (com_nbw_lang == 'pt-br') {
            if (tw) {
              return ('Eu rolie ' + $mark.html()  + ' pixels em direcao a um mundo melhor. http://www.wavetele.com');
            }
            else {
              return ('Eu rolie ' + $mark.html()  + ' pixels em dire&ccedil;&atilde;o a um mundo melhor. http://www.wavetele.com');
            }
          }
          else {
            return ('I scrolled ' + $mark.html()  + ' pixels toward a Better World. http://www.wavetele.com');
          }
...
//this code is repeated above in the 1st function for the footer icons 
    if (com_nbw_lang == 'pt-br') { //notice the language. I will have to make the change to maybe 'en-US' or what ever i need 
        ...
        $a_fb
          .bind('click',
            function(e){
              ...
              var _fb = window.open('http://www.facebook.com/sharer.php?s=100&p[url]=http://www.wavetele.com&p[title]='+$share_fb+'&p[images][0]=http://www.betterworld.com/images/nbw_facebook.png' ,'_fb','width=550,height=450')
        ...
        $a_twitter.bind('click', function(e) {
              ...
              var _tweet = window.open('http://twitter.com/?status='+$share_tw + escape(' #NikeBetterWorld') +' http://www.wavetele.com','_tweet','width=1024,height=600,scrollbars=yes');
...
//andre test button orkut (this is the 2nd of two button calls)
    $a_orkut
          .bind('click',
            function(e){
          //i am going to need to change this variable "_fb" to "_orkut" in both of my button functions once i get the correct url
              var _orkut = window.open('http://promote.orkut.com/preview?nt=orkut.com&tn=https://dl.dropboxusercontent.com/u/47807983/wavetele.com/images/nbw_facebook.png&tt=Nike%20Better%20World&du=http://www.wavetele.com&cn='+$share_ok,'_orkut','width=550,height=450')
